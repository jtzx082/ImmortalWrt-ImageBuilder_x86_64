...
CLASH_DEV_URL2="https://github.com/SunHHB/ShellCrash/raw/master/bin/clash/clash-linux-amd64"
CLASH_TUN_URL2="https://github.com/SunHHB/ShellCrash/raw/master/bin/clashpre/clash-linux-amd64"
CLASH_META_URL2="https://github.com/SunHHB/ShellCrash/raw/master/bin/meta/clash-linux-amd64"
...
wget -qO- $CLASH_DEV_URL2 > files/etc/openclash/core/clash
wget -qO- $CLASH_META_URL2 > files/etc/openclash/core/clash_meta
wget -qO- $CLASH_TUN_URL2 > files/etc/openclash/core/clash_tun
